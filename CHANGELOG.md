...
- Standardized release jar naming to `auto_shulker_inventory-<loader>-<version>+mc<range>` (e.g. `auto_shulker_inventory-fabric-1.5.0+mc26.1-26.1.2.jar`)
- Corrected author and contact metadata (Modrinth page and GitHub links) across the mod and its documentation

### Fixed
- Fixed mojibake (broken UTF-8 characters) in this changelog
