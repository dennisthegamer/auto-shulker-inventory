 ...
 *
 * <p>common must never call loader classes, so the client entrypoints install the actual
 * sender here at init time. On a dedicated server nobody installs one and the default
 * no-op applies.
 *
